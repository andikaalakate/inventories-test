        ...
        <form action="{{ route('admin.siswa.store') }}" method="post" enctype="multipart/form-data"
            ...
            <div class="flex flex-col">
                ...
                <input required
                    ...
                    type="text" id="nisn" name="nisn" placeholder="Masukkan nisn siswa">
            </div>
            ...
            <div class="flex flex-col">
                ...
                <input required
                    class="border border-[#3a3a3a] bg-[#4a4a4a] placeholder:text-gray-200 rounded-lg p-2 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    type="text" id="nama" name="nama" placeholder="Masukkan nama siswa">
            </div>
            ...
            <div class="flex flex-col">
                ...
                <input required
                    class="border border-[#3a3a3a] bg-[#4a4a4a] placeholder:text-gray-200 rounded-lg p-2 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    type="text" id="tempat_lahir" name="tempat_lahir" placeholder="Masukkan tempat lahir siswa">
            </div>
            ...
            <div class="flex flex-col">
                ...
                <input required
                    class="border border-[#3a3a3a] bg-[#4a4a4a] placeholder:text-gray-200 rounded-lg p-2 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    type="date" id="tgl_lahir" name="tgl_lahir" placeholder="Masukkan tanggal lahir siswa">
            </div>
            ...
            <div class="flex flex-col">
                ...
                <input required
                    class="border border-[#3a3a3a] bg-[#4a4a4a] placeholder:text-gray-200 rounded-lg p-2 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    type="text" maxlength="18" id="no_hp" name="no_hp" placeholder="Masukkan no hp siswa">
            </div>
