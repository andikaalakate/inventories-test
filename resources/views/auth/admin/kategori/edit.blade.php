...
@section('body')
    <section class="flex justify-between items-center pb-4 pt-8 px-8">
        ...
        <a href="{{ route('admin.kategori.list') }}" class="text-sm font-bold rounded-md border-2 py-2 px-4 border-slate-200">Kembali</a>
    </section>
        ...
        <form action="{{ route('admin.kategori.update', $kategori->id) }}" method="post" enctype="multipart/form-data"
            ...
            <div class="flex flex-col">
                ...
                <input
                    ...
                    type="text" id="nama" name="nama" value="{{ $kategori->nama }}" placeholder="Masukkan nama kategori">
            </div>
