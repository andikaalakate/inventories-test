...
@section('body')
    <section class="flex justify-between items-center pb-4 pt-8 px-8">
        ...
        <a href="{{ route(auth()->guard('admin')->check() ? 'admin.kategori.list' : 'pegawai.kategori.list') }}" class="text-sm font-bold rounded-md border-2 py-2 px-4 border-slate-200">Kembali</a>
    </section>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="flex flex-col">
                ...
                <input readonly
                    ...
                    type="text" id="nama" value="{{ $kategori->nama }}" placeholder="Masukkan nama kategori">
            </div>
        </div>
    </section>
